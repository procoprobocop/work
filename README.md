...
2. Если будет ставиться VipNet заранее скиньте на флешку dst-файл и секретный ключ, если будет ставиться Lotus, то заранее скиньте на флешку id-файл и desktop8.ndk (их можно подменить в папке **C:\Lotus\Notes\Data** чтобы не настраивать РМ заново).
